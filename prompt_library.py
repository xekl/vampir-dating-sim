...
DIALOG_MANAGEMENT_PROMPT = """Du bist Dialogmanager in einem Dating-Sim-Spiel und analysierst den Chat zwischen Charakter {character_name} und einem Match, der/die versucht ein Date auszumachen. 
...
- meeting_planned ist dann true, wenn sich im Gespräch zeigt, dass BEIDE Partner ein Treffen wollen und planen. Solange nur eine Seite ein Treffen vorgeschlagen hat (oder niemand), ist meeting_planned false. 
...
- interest_level soll sich pro Runde nur langsam verändern, maximal 10-15 Punkte.
- Ab einem interest_level von 80 ist es realistisch, dass der Charakter einem Vorschlag zustimmt oder selbst einen macht.
